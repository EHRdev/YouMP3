...
class ListDownloads extends Component {
  ...
  getMultiple = async () => {
    ...
    try {
      ...
      this.setState({ newObject: zvalues, currentItem: zvalues });
  ...
  render() {
    ...
    const { newObject, currentItem, downloadProgress, progressColor, status, isIndeterminate, showSnack } = this.state;
